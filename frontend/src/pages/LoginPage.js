...
export default function LoginPage() {
  const { t } = useLanguage();
  const { loginWithGoogle, loginWithOrcid, isAuthenticated } = useAuth();
          ...
          <Card className="w-full max-w-md border-stone-200 shadow-lg">
            ...
            <CardContent className="pt-6">
              {!showOrcidForm ? (
                ...
                <form onSubmit={handleOrcidLogin} className="space-y-4">
                  <Button 
                    type="button"
                    variant="ghost" 
                    size="sm" 
                  ...
                  <div>
                    <Label htmlFor="orcid" className="text-stone-700">ORCID ID *</Label>
                    <Input 
                      id="orcid"
                      value={orcidId}
                  ...
                  <div>
                    <Label htmlFor="name" className="text-stone-700">Display Name (optional)</Label>
                    <Input 
                      id="name"
                      value={orcidName}
